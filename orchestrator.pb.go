...
type ExecuteWorkflowNodeRequest struct {
	...
	NodeOutputJson      string `protobuf:"bytes,11,opt,name=node_output_json,json=nodeOutputJson,proto3" json:"node_output_json,omitempty"`
...
func (x *ExecuteWorkflowNodeRequest) GetNodeOutputJson() string {
	if x != nil {
...
const file_orchestrator_proto_rawDesc = "" +
	"\n" +
	"\x12orchestrator.proto\x12\x18document.orchestrator.v1\x1a\fmodels.proto\"\xe1\a\n" +
	...
	"\fglobal_state\x18\n" +
	" \x01(\v2\x1f.document.models.v1.GlobalStateR\vglobalState\x12(\n" +
	"\x10node_output_json\x18\v \x01(\tR\x0enodeOutputJson\x122\n" +
...
var file_orchestrator_proto_goTypes = []any{
	...
	(*ErrorContract)(nil),                 // 19: document.models.v1.ErrorContract
}
var file_orchestrator_proto_depIdxs = []int32{
	...
	19, // 8: document.orchestrator.v1.ExecuteWorkflowNodeRequest.error_contract:type_name -> document.models.v1.ErrorContract
	12, // 9: document.orchestrator.v1.ListenRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	12, // 10: document.orchestrator.v1.ProgressUpdate.identity:type_name -> document.models.v1.InfrastructureIdentity
	12, // 11: document.orchestrator.v1.ResumeJobRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	12, // 12: document.orchestrator.v1.PurgeSystemStateRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	0,  // 13: document.orchestrator.v1.OrchestratorService.ExecuteWorkflowNode:input_type -> document.orchestrator.v1.ExecuteWorkflowNodeRequest
	...
	0,  // 17: document.orchestrator.v1.OrchestratorCallbackService.OnNodeExecutionComplete:input_type -> document.orchestrator.v1.ExecuteWorkflowNodeRequest
	0,  // 18: document.orchestrator.v1.OrchestratorCallbackService.OnJobFailed:input_type -> document.orchestrator.v1.ExecuteWorkflowNodeRequest
	0,  // 19: document.orchestrator.v1.OrchestratorCallbackService.OnJobSuspended:input_type -> document.orchestrator.v1.ExecuteWorkflowNodeRequest
	...
	8,  // 24: document.orchestrator.v1.OrchestratorCallbackService.OnNodeExecutionComplete:output_type -> document.orchestrator.v1.NodeExecutionCompleteResponse

...
type ExecuteWorkflowNodeRequest struct {
	...
	AiServiceContract      *AiServiceContract      `protobuf:"bytes,13,opt,name=ai_service_contract,json=aiServiceContract,proto3" json:"ai_service_contract,omitempty"`
	DocServiceContract     *DocServiceContract     `protobuf:"bytes,14,opt,name=doc_service_contract,json=docServiceContract,proto3" json:"doc_service_contract,omitempty"`
	CacheServiceContract   *CacheServiceContract   `protobuf:"bytes,15,opt,name=cache_service_contract,json=cacheServiceContract,proto3" json:"cache_service_contract,omitempty"`
	StorageServiceContract *StorageServiceContract `protobuf:"bytes,16,opt,name=storage_service_contract,json=storageServiceContract,proto3" json:"storage_service_contract,omitempty"`
...
func (x *ExecuteWorkflowNodeRequest) GetAiServiceContract() *AiServiceContract {
	if x != nil {
		return x.AiServiceContract
	}
	return nil
}

func (x *ExecuteWorkflowNodeRequest) GetDocServiceContract() *DocServiceContract {
	if x != nil {
		return x.DocServiceContract
	}
	return nil
}

func (x *ExecuteWorkflowNodeRequest) GetCacheServiceContract() *CacheServiceContract {
	if x != nil {
		return x.CacheServiceContract
	}
	return nil
}

func (x *ExecuteWorkflowNodeRequest) GetStorageServiceContract() *StorageServiceContract {
	if x != nil {
		return x.StorageServiceContract
	}
	return nil
}
...
func (x *JobFailedRequest) GetGlobalState() *structpb.Struct {
	if x != nil {
		return x.GlobalState
	}
	return nil
...
func (x *JobSuspendedRequest) GetSuspendedStepId() string {
	if x != nil {
		return x.SuspendedStepId
	}
	return ""
}
...
func (x *JobSuspendedRequest) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *JobSuspendedRequest) GetGlobalState() *structpb.Struct {
	if x != nil {
		return x.GlobalState
	}
	return nil
...
const file_orchestrator_proto_rawDesc = "" +
	"\n" +
	"\x12orchestrator.proto\x12\x18document.orchestrator.v1\x1a\fmodels.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x8c\a\n" +
	...
	"nodeConfig\x12F\n" +
	"\bidentity\x18\a \x01(\v2*.document.models.v1.InfrastructureIdentityR\bidentity\x122\n" +
	"\x15inference_retry_count\x18\f \x01(\x05R\x13inferenceRetryCount\x12U\n" +
	"\x13ai_service_contract\x18\r \x01(\v2%.document.models.v1.AiServiceContractR\x11aiServiceContract\x12X\n" +
	"\x14doc_service_contract\x18\x0e \x01(\v2&.document.models.v1.DocServiceContractR\x12docServiceContract\x12^\n" +
	"\x16cache_service_contract\x18\x0f \x01(\v2(.document.models.v1.CacheServiceContractR\x14cacheServiceContract\x12d\n" +
	"\x18storage_service_contract\x18\x10 \x01(\v2*.document.models.v1.StorageServiceContractR\x16storageServiceContract\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\b\x10\tJ\x04\b\t\x10\n" +
	"J\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\f\"j\n" +
	"\x1bExecuteWorkflowNodeResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x17\n" +
	"\astep_id\x18\x03 \x01(\tR\x06stepId\"W\n" +
	"\rListenRequest\x12F\n" +
	"\bidentity\x18\x02 \x01(\v2*.document.models.v1.InfrastructureIdentityR\bidentity\"\xb8\x01\n" +
	"\x0eProgressUpdate\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage\x12,\n" +
	"\x12final_results_json\x18\x04 \x01(\tR\x10finalResultsJson\x12F\n" +
	"\bidentity\x18\x05 \x01(\v2*.document.models.v1.InfrastructureIdentityR\bidentity\"\x9a\x01\n" +
	...
	"\x10PurgeSystemState\x121.document.orchestrator.v1.PurgeSystemStateRequest\x1a2.document.orchestrator.v1.PurgeSystemStateResponse2\x87\x03\n" +
...
var file_orchestrator_proto_goTypes = []any{
	...
	(*JobSuspendedResponse)(nil),          // 13: document.orchestrator.v1.JobSuspendedResponse
	nil,                                   // 14: document.orchestrator.v1.ExecuteWorkflowNodeRequest.MetadataEntry
	nil,                                   // 15: document.orchestrator.v1.NodeExecutionCompleteRequest.MetadataEntry
	nil,                                   // 16: document.orchestrator.v1.JobFailedRequest.MetadataEntry
	nil,                                   // 17: document.orchestrator.v1.JobSuspendedRequest.MetadataEntry
	...
	(*AiServiceContract)(nil),             // 21: document.models.v1.AiServiceContract
	(*DocServiceContract)(nil),            // 22: document.models.v1.DocServiceContract
	(*CacheServiceContract)(nil),          // 23: document.models.v1.CacheServiceContract
	(*StorageServiceContract)(nil),        // 24: document.models.v1.StorageServiceContract
	(*ErrorContract)(nil),                 // 25: document.models.v1.ErrorContract
}
var file_orchestrator_proto_depIdxs = []int32{
	...
	21, // 4: document.orchestrator.v1.ExecuteWorkflowNodeRequest.ai_service_contract:type_name -> document.models.v1.AiServiceContract
	22, // 5: document.orchestrator.v1.ExecuteWorkflowNodeRequest.doc_service_contract:type_name -> document.models.v1.DocServiceContract
	23, // 6: document.orchestrator.v1.ExecuteWorkflowNodeRequest.cache_service_contract:type_name -> document.models.v1.CacheServiceContract
	24, // 7: document.orchestrator.v1.ExecuteWorkflowNodeRequest.storage_service_contract:type_name -> document.models.v1.StorageServiceContract
	...
	25, // 16: document.orchestrator.v1.NodeExecutionCompleteRequest.error_contract:type_name -> document.models.v1.ErrorContract
	20, // 17: document.orchestrator.v1.JobFailedRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	16, // 18: document.orchestrator.v1.JobFailedRequest.metadata:type_name -> document.orchestrator.v1.JobFailedRequest.MetadataEntry
	18, // 19: document.orchestrator.v1.JobFailedRequest.global_state:type_name -> google.protobuf.Struct
	18, // 20: document.orchestrator.v1.JobFailedRequest.node_output:type_name -> google.protobuf.Struct
	25, // 21: document.orchestrator.v1.JobFailedRequest.error_contract:type_name -> document.models.v1.ErrorContract
	20, // 22: document.orchestrator.v1.JobSuspendedRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	17, // 23: document.orchestrator.v1.JobSuspendedRequest.metadata:type_name -> document.orchestrator.v1.JobSuspendedRequest.MetadataEntry
	18, // 24: document.orchestrator.v1.JobSuspendedRequest.global_state:type_name -> google.protobuf.Struct
	18, // 25: document.orchestrator.v1.JobSuspendedRequest.node_output:type_name -> google.protobuf.Struct
	25, // 26: document.orchestrator.v1.JobSuspendedRequest.error_contract:type_name -> document.models.v1.ErrorContract
	0,  // 27: document.orchestrator.v1.OrchestratorService.ExecuteWorkflowNode:input_type -> document.orchestrator.v1.ExecuteWorkflowNodeRequest
	2,  // 28: document.orchestrator.v1.OrchestratorService.ListenForProgress:input_type -> document.orchestrator.v1.ListenRequest
	4,  // 29: document.orchestrator.v1.OrchestratorService.ResumeJob:input_type -> document.orchestrator.v1.ResumeJobRequest
	6,  // 30: document.orchestrator.v1.OrchestratorService.PurgeSystemState:input_type -> document.orchestrator.v1.PurgeSystemStateRequest
	8,  // 31: document.orchestrator.v1.OrchestratorCallbackService.OnNodeExecutionComplete:input_type -> document.orchestrator.v1.NodeExecutionCompleteRequest
	10, // 32: document.orchestrator.v1.OrchestratorCallbackService.OnJobFailed:input_type -> document.orchestrator.v1.JobFailedRequest
	12, // 33: document.orchestrator.v1.OrchestratorCallbackService.OnJobSuspended:input_type -> document.orchestrator.v1.JobSuspendedRequest
	1,  // 34: document.orchestrator.v1.OrchestratorService.ExecuteWorkflowNode:output_type -> document.orchestrator.v1.ExecuteWorkflowNodeResponse
	3,  // 35: document.orchestrator.v1.OrchestratorService.ListenForProgress:output_type -> document.orchestrator.v1.ProgressUpdate
	5,  // 36: document.orchestrator.v1.OrchestratorService.ResumeJob:output_type -> document.orchestrator.v1.ResumeJobResponse
	7,  // 37: document.orchestrator.v1.OrchestratorService.PurgeSystemState:output_type -> document.orchestrator.v1.PurgeSystemStateResponse
	9,  // 38: document.orchestrator.v1.OrchestratorCallbackService.OnNodeExecutionComplete:output_type -> document.orchestrator.v1.NodeExecutionCompleteResponse
	11, // 39: document.orchestrator.v1.OrchestratorCallbackService.OnJobFailed:output_type -> document.orchestrator.v1.JobFailedResponse
	13, // 40: document.orchestrator.v1.OrchestratorCallbackService.OnJobSuspended:output_type -> document.orchestrator.v1.JobSuspendedResponse

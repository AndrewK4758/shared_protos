...
type QueryBlankDocumentRequest struct {
	state               protoimpl.MessageState  `protogen:"open.v1"`
	CollectionName      string                  `protobuf:"bytes,1,opt,name=collection_name,json=collectionName,proto3" json:"collection_name,omitempty"`
	TextRepresentation  string                  `protobuf:"bytes,2,opt,name=text_representation,json=textRepresentation,proto3" json:"text_representation,omitempty"` // Extracted layout metadata or URL to blank image
	Identity            *InfrastructureIdentity `protobuf:"bytes,3,opt,name=identity,proto3" json:"identity,omitempty"`
...
func (x *QueryBlankDocumentRequest) GetTextRepresentation() string {
	if x != nil {
...
type RegisterBlankDocumentRequest struct {
	state              protoimpl.MessageState  `protogen:"open.v1"`
	CollectionName     string                  `protobuf:"bytes,1,opt,name=collection_name,json=collectionName,proto3" json:"collection_name,omitempty"`
	TextRepresentation string                  `protobuf:"bytes,2,opt,name=text_representation,json=textRepresentation,proto3" json:"text_representation,omitempty"`
	Identity           *InfrastructureIdentity `protobuf:"bytes,3,opt,name=identity,proto3" json:"identity,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *RegisterBlankDocumentRequest) GetTextRepresentation() string {
	if x != nil {
		return x.TextRepresentation
	}
	return ""
...
const file_semantic_cache_proto_rawDesc = "" +
	...
	"\x06exists\x18\x01 \x01(\bR\x06exists\"\xf0\x01\n" +
	"\x19QueryBlankDocumentRequest\x12'\n" +
	"\x0fcollection_name\x18\x01 \x01(\tR\x0ecollectionName\x12/\n" +
	"\x13text_representation\x18\x02 \x01(\tR\x12textRepresentation\x12F\n" +
	...
	"confidence\x125\n" +
	"\x16matched_classification\x18\x03 \x01(\tR\x15matchedClassification\"\xc0\x01\n" +
...
var file_semantic_cache_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_semantic_cache_proto_goTypes = []any{
	...
	nil,                                   // 13: semanticcache.v1.CheckCacheRequest.MetadataEntry
	nil,                                   // 14: semanticcache.v1.StoreExtractionRequest.MetadataEntry
	nil,                                   // 15: semanticcache.v1.SeedCacheRequest.MetadataEntry
	nil,                                   // 16: semanticcache.v1.CheckMetadataRequest.MetadataEntry
	(*InfrastructureIdentity)(nil),        // 17: document.models.v1.InfrastructureIdentity
}
var file_semantic_cache_proto_depIdxs = []int32{
	17, // 0: semanticcache.v1.CheckCacheRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	13, // 1: semanticcache.v1.CheckCacheRequest.metadata:type_name -> semanticcache.v1.CheckCacheRequest.MetadataEntry
	17, // 2: semanticcache.v1.StoreExtractionRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	14, // 3: semanticcache.v1.StoreExtractionRequest.metadata:type_name -> semanticcache.v1.StoreExtractionRequest.MetadataEntry
	17, // 4: semanticcache.v1.SeedCacheRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	15, // 5: semanticcache.v1.SeedCacheRequest.metadata:type_name -> semanticcache.v1.SeedCacheRequest.MetadataEntry
	2,  // 6: semanticcache.v1.CacheStoreMessage.request:type_name -> semanticcache.v1.StoreExtractionRequest
	17, // 7: semanticcache.v1.CheckMetadataRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	16, // 8: semanticcache.v1.CheckMetadataRequest.metadata:type_name -> semanticcache.v1.CheckMetadataRequest.MetadataEntry
	17, // 9: semanticcache.v1.QueryBlankDocumentRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	17, // 10: semanticcache.v1.RegisterBlankDocumentRequest.identity:type_name -> document.models.v1.InfrastructureIdentity
	0,  // 11: semanticcache.v1.SemanticCacheService.CheckCache:input_type -> semanticcache.v1.CheckCacheRequest
	2,  // 12: semanticcache.v1.SemanticCacheService.StoreExtraction:input_type -> semanticcache.v1.StoreExtractionRequest
	4,  // 13: semanticcache.v1.SemanticCacheService.SeedCache:input_type -> semanticcache.v1.SeedCacheRequest
	7,  // 14: semanticcache.v1.SemanticCacheService.CheckMetadataExists:input_type -> semanticcache.v1.CheckMetadataRequest
	9,  // 15: semanticcache.v1.SemanticCacheService.QueryBlankDocument:input_type -> semanticcache.v1.QueryBlankDocumentRequest
	11, // 16: semanticcache.v1.SemanticCacheService.RegisterBlankDocument:input_type -> semanticcache.v1.RegisterBlankDocumentRequest
	1,  // 17: semanticcache.v1.SemanticCacheService.CheckCache:output_type -> semanticcache.v1.CheckCacheResponse
	3,  // 18: semanticcache.v1.SemanticCacheService.StoreExtraction:output_type -> semanticcache.v1.StoreExtractionResponse
	5,  // 19: semanticcache.v1.SemanticCacheService.SeedCache:output_type -> semanticcache.v1.SeedCacheResponse
	8,  // 20: semanticcache.v1.SemanticCacheService.CheckMetadataExists:output_type -> semanticcache.v1.CheckMetadataResponse
	10, // 21: semanticcache.v1.SemanticCacheService.QueryBlankDocument:output_type -> semanticcache.v1.QueryBlankDocumentResponse
	12, // 22: semanticcache.v1.SemanticCacheService.RegisterBlankDocument:output_type -> semanticcache.v1.RegisterBlankDocumentResponse
